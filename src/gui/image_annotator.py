...
def annotate_prediction(image, predicted_name, confidence, position="top-center"):
...
def draw_all_annotations(image, yolo_boxes=None, retinaface_boxes=None, 
                        predicted_name=None, confidence=None):
    ...
    if predicted_name and confidence is not None:
